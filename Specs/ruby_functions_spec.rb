...
require( 'minitest/rg' )
require_relative( '../functions/ruby_functions_practice' )

class FunctionsTest < MiniTest::Test

  #def test_(any_function_name)
    #result = (actual_function_name(any_arguments_required_by_function))
